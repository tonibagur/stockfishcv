...
#warning omar
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        // Board
        boardView =
        [[BoardView alloc] initWithFrame: CGRectMake(0.0f, 18.0f/*38.0f*//*18.0f*/, appRect.size.width, appRect.size.width)];
        [contentView addSubview: boardView];
        ...
        {
            offsetDual = analysisView.frame.size.height;
            
            bookMovesView = [[UILabel alloc] initWithFrame: CGRectMake(0.0f, analysisView.frame.origin.y + analysisView.frame.size.height+1, appRect.size.width, 18.0f)];
