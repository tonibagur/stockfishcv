...
int
quicksort_datetime(npy_datetime *start, npy_intp num, void *NOT_USED)
{
    npy_datetime vp;
    npy_datetime *pl = start;
    npy_datetime *pr = start + num - 1;
...
int
aquicksort_datetime(npy_datetime *v, npy_intp* tosort, npy_intp num, void *NOT_USED)
{
    npy_datetime vp;
    npy_intp *pl = tosort;
    npy_intp *pr = tosort + num - 1;
...
int
quicksort_timedelta(npy_timedelta *start, npy_intp num, void *NOT_USED)
{
    npy_timedelta vp;
    npy_timedelta *pl = start;
    npy_timedelta *pr = start + num - 1;
...
int
aquicksort_timedelta(npy_timedelta *v, npy_intp* tosort, npy_intp num, void *NOT_USED)
{
    npy_timedelta vp;
    npy_intp *pl = tosort;
    npy_intp *pr = tosort + num - 1;
