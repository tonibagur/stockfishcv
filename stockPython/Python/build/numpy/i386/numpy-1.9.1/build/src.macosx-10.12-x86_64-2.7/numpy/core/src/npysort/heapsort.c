...
int
heapsort_datetime(npy_datetime *start, npy_intp n, void *NOT_USED)
{
    npy_datetime tmp, *a;
    npy_intp i,j,l;
...
int
aheapsort_datetime(npy_datetime *v, npy_intp *tosort, npy_intp n, void *NOT_USED)
{
    npy_intp *a, i,j,l, tmp;
    /* The arrays need to be offset by one for heapsort indexing */
    a = tosort - 1;
...
int
heapsort_timedelta(npy_timedelta *start, npy_intp n, void *NOT_USED)
{
    npy_timedelta tmp, *a;
    npy_intp i,j,l;
...
int
aheapsort_timedelta(npy_timedelta *v, npy_intp *tosort, npy_intp n, void *NOT_USED)
{
    npy_intp *a, i,j,l, tmp;
    /* The arrays need to be offset by one for heapsort indexing */
    a = tosort - 1;
